const styles = {
  ...
  infoText: 'font-rajdhani font-medium text-lg text-[#9e1e22] cursor-pointer',
  ...
  hocLogo: 'w-[220px] h-[60px]   object-contain cursor-pointer',
  ...
  battleGroundsWrapper: 'flex-wrap  max-w-[1200px] h-auto',
  battleGroundCard: ' w-1/3  h-auto p-2 glass-morphism m-4 rounded-lg cursor-pointer battle-card',
  ...
  // Game page
  gameContainer: 'max-w-screen h-screen bg-cover bg-no-repeat bg-center flex-col',
  ...
  playerHealth: 'flex flex-row bg-white rounded-md p-2 sm:min-w-[512px] min-w-[156px] sm:min-h-[48px] min-h-[40px] bg-opacity-10 backdrop-filter backdrop-blur-lg mx-3',
  playerHealthBar: 'sm:w-4 w-1 sm:h-8 h-6 rounded-sm',
  ...
  cardContainer: 'relative sm:w-[234px] w-[198px] sm:h-[300px] h-[252px] z-0 transition-all ',
  cardImg: 'w-full h-full object-contain',
  cardPointContainer: 'absolute sm:w-[40px] w-[32px] sm:h-[40px] h-[32px] rounded-[25px] bottom-[30.5%]  sm:bottom-[30.4%]',
  cardPoint: 'font-rajdhani text-[25px] sm:text-[30px]  font-bold',
  cardTextContainer: 'absolute w-full bottom-[13.5%] left-3',
  cardText: 'font-rajdhani text-[26px] font-bold text-white',

  // custom button component
  btn: 'px-4 py-2 rounded-lg bg-[#9e1e22] w-fit text-white font-rajdhani font-bold',

  // custom input component
  label: 'font-rajdhani font-semibold text-2xl text-white mb-3',
  input: 'bg-siteDimBlack text-white outline-none focus:outline-[#9e1e22] p-4 rounded-md sm:w-[50%] w-full',

  // gameload component
  gameLoadContainer: 'absolute inset-0 z-10 w-full top-0 h-screen gameload flex-col',
  ...
  gameInfoIcon: 'bg-[#9e1e22] w-10 h-10 rounded-md cursor-pointer',
  ...
  gameInfoSidebarClose: 'w-10 h-10 rounded-md bg-[#9e1e22] text-white font-rajdhani font-extrabold text-xl cursor-pointer',
